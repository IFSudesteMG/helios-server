...
Repositório público contendo a release [v1.0.1 - IFSudesteMG](https://github.com/IFSudesteMG/helios-server/releases/tag/ifsudestemg-v1.0.1) para atender os [incisos I e II do Art. 89 do Regulamento Eleitoral do IF Sudeste MG 2024 Consolidado](https://www.ifsudestemg.edu.br/eleicoes/eleicao-geral-2024).
